...
#define directWrite32Offset(addr, offs, value) _directWrite32((u32*)((u32)(&(addr))+(offs)), value)
...
/* Common Vars */
char gameRegion;
char FasterMenu, MiiHeads, NoMusic, NoCharVoice, BtGlitch, TimeDiff, Speedometer, NoMultiChan, ThirtyFPS;
